...
| `Paper/` | The LaTeX manuscript (`paper_draft/`: `main.tex`, section files, `references.bib`/`.bbl`, `figures/`), the single-file `main_standalone.tex`, a compiled reference PDF (`compiled_manuscript_2026-09-09.pdf`, which predates the final abstract/Highlights compression), and the Overleaf upload bundles. The current bundle is `Overleaf_Upload_SINGLE_2026-09-09.zip`. |
